...
def to_px(p, scale, size):
    """
    convert_dir point from coordinate units to screen pixel units
...
def from_px(x, y, scale, size):
    """
    convert_dir point from screen pixel units to coordinate units
...
def to_line_equation(coefs, p):
    ...
    :param coefs: proc_list or tuple of 3 elements (or anything that can be unzipped to 3 elements)
    :param p: point
...
def intersect(l1, l2):
    ...
    :param l1: proc_list or tuple of 3 elements [a1, b1, c1]
    :param l2: proc_list or tuple of 3 elements [a2, b2, c2]
