...
from neural_network.HW_3.cars.utils import CarState, get_line_coefs, to_line_equation, define_sector, Action, rotate
...
class Physics(object):
    ...
    def move(self, *args, **kwargs):
        ...
        :return: proc_list of new coordinates for n ticks ahead (n is set on init)
        """
        pass
